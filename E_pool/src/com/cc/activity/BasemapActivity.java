...
public class BasemapActivity extends SlidingFragmentActivity implements OnClickListener, OnMapClickListener,OnMarkerClickListener,OnGetGeoCoderResultListener{
	...
	public void initevent() {
		...
		Const.mStartLocationData = null;
		Const.mEndLocationData = null;
		Const.isSetStart = false;
		input_start = (Button) findViewById(R.id.input_start);
	...
	public void initMap() {
		...
		MapStatusUpdate msu=MapStatusUpdateFactory.zoomTo(21.5f);
	...
	public void inputStart() {
		// TODO Auto-generated method stub
		Util.startActivity(BasemapActivity.this, InputStartActivity.class);
	}

	public void start_go() {
		// TODO Auto-generated method stub
		if (Const.isSetStart) {
			Util.startActivity(BasemapActivity.this, PoiSearchActivity.class);
		}else {
			Const.mStartLocationData = Const.mLastLocationData;
			Const.startString = Const.locationString;
			Const.isSetStart =true;
			Util.startActivity(BasemapActivity.this, PoiSearchActivity.class);
		}
	}
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if (mode.equals("罗盘模式")) {
					MyLocationConfiguration config=new 
							MyLocationConfiguration(com.baidu.mapapi.map.MyLocationConfiguration.LocationMode.COMPASS, true, myBitmapLocation);
					myBaiduMap.setMyLocationConfigeration(config);
				}else if (mode.equals("跟随模式")) {
					MyLocationConfiguration config=new 
							MyLocationConfiguration(com.baidu.mapapi.map.MyLocationConfiguration.LocationMode.FOLLOWING, true, myBitmapLocation);
					myBaiduMap.setMyLocationConfigeration(config);
				}else if (mode.equals("普通模式")) {
					MyLocationConfiguration config=new 
							MyLocationConfiguration(com.baidu.mapapi.map.MyLocationConfiguration.LocationMode.NORMAL, true, myBitmapLocation);
					myBaiduMap.setMyLocationConfigeration(config);
	...
	class MyLocationListener implements BDLocationListener {
		...
		public void onReceiveLocation(BDLocation location) {
	        ...
	        if (isFirstLoc) {  
	            ...
	            Const.locationString = location.getAddrStr();
	        }  
		}
	}
