 ...
 * 演示poi搜索功能
 */
public class PoiSearchActivity extends SlidingFragmentActivity implements
	...
	public void onGetPoiDetailResult(PoiDetailResult result) {
		...
		Const.endAddress = result.getAddress();
		Const.mEndLocationData = result.getLocation();
		Const.endString = result.getName();
		new AlertDialog.Builder(PoiSearchActivity.this).setTitle("提示！")
				.setMessage("您是否要选择" + Const.endString)
				.setPositiveButton("是", new DialogInterface.OnClickListener() {

					@Override
					public void onClick(DialogInterface dialog, int which) {
						// TODO Auto-generated method stub
						Util.startActivity(PoiSearchActivity.this, BasemapActivity.class);
					}
