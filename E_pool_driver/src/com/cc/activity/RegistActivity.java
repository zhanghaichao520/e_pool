...
public class RegistActivity extends Activity implements OnClickListener {
	...
	public void initevent() {
		...
		carnum_edt = (EditText) findViewById(R.id.input_carnum);
	...
	public void registUser() {
		...
		if (password_edt.getText().toString().equals(repwd_edt.getText().toString())) {
			if (name_edt.getText().toString().trim().equals("")
				||carnum_edt.getText().toString().trim().equals("")) {
				Util.toast("姓名和车牌号不能为空", RegistActivity.this);
				return;
			}
			...
			user.setCarNum(carnum_edt.getText().toString());
