...
public class PersonalActivity extends SlidingFragmentActivity implements
	...
	private TextView carnumSet_btn;
	...
	public void initevent() {
		...
		carnum_txt = (TextView) findViewById(R.id.setCarnum);
		...
		carnum_txt.setText(myUser.getCarNum());
	}
	...
	private void updateCarnum() {
		...
		builder.setTitle("更改车牌号").setIcon(android.R.drawable.ic_dialog_info).setView(inputServer).setNegativeButton("取消",
				null);
		builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {

			public void onClick(DialogInterface dialog, int which) {
				User newUser = new User();
				newUser.setCarNum(inputServer.getText().toString().trim());
				newUser.update(myUser.getObjectId(), new UpdateListener() {
					...
					public void done(BmobException arg0) {
						...
						if (arg0==null) {
							...
							carnum_txt.setText(inputServer.getText().toString().trim());
						}else{
